            ...
            <ul className="space-y-4">
              {card.features.map((feature) => (
                <li key={feature} className="flex items-center gap-3">
                  <Check className="w-5 h-5 text-[#22a716] flex-shrink-0" />
...
export default function CardStack() {
  ...
  return (
    <>
      ...
      <div className="overflow-hidden min-h-screen rounded-2xl bg-gradient-to-br from-[#021B2C] via-[#000B44] to-[#000B64] flex flex-col items-center justify-center p-4 font-sans">
