        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* <div className="bg-[#004D22] text-white p-6 sm:p-10 rounded-2xl shadow-xl border border-[#005C29] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="text-[#021B2C] font-semibold tracking-wider text-xs sm:text-sm uppercase mb-2">
              ...
              <div className="mt-8 grid sm:grid-cols-2 gap-3">
                <div className="flex items-center gap-3 bg-white/10 rounded-lg p-3 border border-white/5">
                  <ShieldCheck className="text-[#021B2C] w-5 h-5 shrink-0" />
                  <span className="text-xs sm:text-sm font-medium">
                    Dedicated Mortgage Guidance
                  </span>
                </div>
                <div className="flex items-center gap-3 bg-white/10 rounded-lg p-3 border border-white/5">
                  <Award className="text-[#021B2C] w-5 h-5 shrink-0" />
                  <span className="text-xs sm:text-sm font-medium">
                    {" "}
                    US Navy Veteran
                  </span>
              ...
              <div className="mt-8 pt-6 border-t border-white/10 grid gap-3 sm:grid-cols-2 text-sm">
                ...
                <a
                  ...
                  className="flex items-center gap-3 hover:text-[#021B2C] transition"
                >
                  <Phone className="w-4 h-4 text-[#021B2C] shrink-0" />
