      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        <div className="relative w-full lg:w-[60%] rounded-3xl ">
          ...
          <div className="absolute hover:border-1 border-[#021B2C] -bottom-7 z-50 md:bottom-28 left-4 md:left-24 bg-white rounded-2xl shadow-lg p-4 sm:p-6 w-[85%] sm:w-[70%]">
            <div className="text-xs font-bold text-teal-600 bg-[#021B2C] hover:text-white hover:bg-[#021B2C]  tracking-widest mb-2 inline-block w-auto rounded-md px-3 py-2">
              CREDIT BUILDING
            </div>
        ...
        <div className="w-full lg:w-[40%] flex flex-col justify-between">
          <div>
            <div className="hidden md:flex flex-col">
              <p className="text-[#021B2C] font-bold tracking-[3px] sm:tracking-[4px] mb-4 text-sm sm:text-base">
                EDUCATION
              </p>
