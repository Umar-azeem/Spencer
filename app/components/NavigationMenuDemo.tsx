...
const loanPrograms = [
  ...
  },
  {
    ...
    description:
      "Refinance and cash-out refinance loans can be beneficial for clients by potentially lowering their monthly payments.",
    icon: RefreshCw,
  },
  {
    title: "Non-QM",
    ...
    description:
      "A Non-QM loan is a type of mortgage loan that does not meet the standards set by the government-sponsored.",
    icon: Landmark,
  },
  {
    title: "Rehab Loans",
