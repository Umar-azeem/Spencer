    ...
    <div className="bg-[#f5f5f5] min-h-screen">
      ...
      <div className="bg-gradient-to-b rounded-2xl from-[#021B2C] to-[#004a25] text-white py-16 sm:py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-1.5 text-sm text-[#021B2C] mb-6">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                ...
                <div className="flex gap-2 mt-3">
                  ...
                  {officer.cell && (
                    <a
                      ...
                      className="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-[#021B2C] bg-green-50 rounded-lg hover:bg-[#021B2C] transition"
                    >
        ...
        <div className="mt-12 bg-[#021B2C] rounded-2xl p-8 text-white text-center">
          ...
          >
            <Phone className="w-5 h-5" /> (415) 569-2119
          </a>
        </div>
