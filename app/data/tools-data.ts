...
export const toolData = {
  ...
  disclaimer:
    "Testimonials may not be representative of all clients and are not a guarantee of future performance. Loan approvals are subject to underwriting. Rates, terms, and programs are subject to change without notice. Equal Housing Lender. NMLS ID:384700.",
};
